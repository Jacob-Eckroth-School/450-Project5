...
Display( )
{
	...
	Pattern->SetUniformVariable("PI", pi);
	Pattern->SetUniformVariable("vertexWarp", vertexWarp);
	Pattern->SetUniformVariable("fragWarp", fragWarp);
	//glutSolidTeapot(2);
	OsuSphere(2, 50, 50);

	Pattern->Use(0);

	glColor3f(uSpecularColor.r, uSpecularColor.g, uSpecularColor.b);
	glPushMatrix();
